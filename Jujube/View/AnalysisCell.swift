...
class AnalysisCell: UITableViewCell {
  ...
  private func downloadImageForActor(_ actor: String) {
    ...
    let urlString = "https://www.googleapis.com/customsearch/v1?q=\(actor)&searchType=image&key=AIzaSyCvOtEwugKp-TxePAQ3V0tZ9uiKw6l6t88&cx=017426432613049717893:d1u8bllqhjo"
